...
public class Activity3 extends AppCompatActivity implements CalcDialog.CalcDialogCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new IonAlert(Activity3.this, IonAlert.WARNING_TYPE)
    ...
    private void setTheme() {
        ...
        TextFieldBoxes box3 = findViewById(R.id.text_box3);
        if (mSharedPreferences.getInt(THEME_SELECTED, 0) == R.style.AppThemeDark) {
            ...
            box3.setPanelBackgroundColor(getColor(R.color.colorGradientStartDark));
