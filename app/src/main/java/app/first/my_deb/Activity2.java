...
public class Activity2 extends AppCompatActivity {
    ...
    private int count = 1;
    private final String score = "app.first.my_deb.score";
    ...
    public void onClick(View view) {
        try {
            ...
            {
                scoreSharPref = getSharedPreferences("Score.txt", MODE_APPEND);
    ...
    private void saveText() {
        sPref = getSharedPreferences("Save2.txt", MODE_PRIVATE);
    ...
    private void loadText(Context context) {
        sPref = context.getSharedPreferences("Save2.txt", MODE_PRIVATE);
