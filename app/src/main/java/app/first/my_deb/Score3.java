...
public class Score3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        val4 = findViewById(R.id.s21);
        val5 = findViewById(R.id.s22);
        val6 = findViewById(R.id.s23);
        val7 = findViewById(R.id.s31);
        val8 = findViewById(R.id.s32);
        val9 = findViewById(R.id.s33);
        val10 = findViewById(R.id.s41);
        val11 = findViewById(R.id.s42);
        val12 = findViewById(R.id.s43);
        val13 = findViewById(R.id.s51);
        val14 = findViewById(R.id.s52);
        val15 = findViewById(R.id.s53);
        val16 = findViewById(R.id.s61);
        val17 = findViewById(R.id.s62);
        val18 = findViewById(R.id.s63);
        val19 = findViewById(R.id.s71);
        val20 = findViewById(R.id.s72);
        val21 = findViewById(R.id.s73);
        val22 = findViewById(R.id.s81);
        val23 = findViewById(R.id.s82);
        val24 = findViewById(R.id.s83);
    ...
    public void onBackPressed() {
        try {
            String ACTION3 = "app.first.my_deb.SHOW_3_ACTIVITY";
    ...
    private void loadText(Context context) {
        sPref = context.getSharedPreferences("Score3.txt", MODE_APPEND);
